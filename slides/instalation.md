...
![Instance configuration](/slides/images/instance_configuration.png)<!-- .element: class="plain" -->

^^^^^^
#### Instalación usando `.war`

![Jenkins is ready](/slides/images/jenkins_is_ready.png)<!-- .element: class="plain" -->

^^^^^^
#### Instalación usando `.war`

![Jenkins is ready](/slides/images/jenkins_home.png)<!-- .element: class="plain" -->
